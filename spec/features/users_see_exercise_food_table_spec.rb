...
RSpec.describe "users see sample food and exercise table", type: :feature do 
  ...
  it "can see the food name that the user selected" do
    visit exercises_path(food_search: ["Trolli Sour Brite Crawlers | Calories: 210"])  
  ...
  it "can see the users weight" do
    visit exercises_path(weight: "150", food_search: ["Trolli Sour Brite Crawlers | Calories: 210"])
  ...
  it "sees amount of time to complete exercises" do     
    ...
    visit exercises_path(weight: "150", food_search: ["Trolli Sour Brite Crawlers | Calories: 400"])
